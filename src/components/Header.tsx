...
export default function Header() {
    ...
    useEffect(() => {
        if (address) {
            fetch(`${import.meta.env.VITE_APP_API_HOST}/pendingcount`, {
                method: "POST",
                body: JSON.stringify({
                    address: address
                }),
            ...
            <div className="mx-auto flex justify-between items-center">
                <div className="flex items-center space-x-4 md:space-x-8">
                    ...
                    >
                        ...
                        ></img>
                        <div className="text-[16px] md:text-[20px] text-[#2C2C3F] font-extrabold">
                            Mullex
                        </div>
                    </div>
                    <nav className="flex max-md:hidden gap-[24px] md:gap-[40px] ml-[24px] md:ml-[60px] text-[#2C2C3F] text-[14px] md:text-[18px]">
                        <Menu>
                            {({ open }) => (
                                <>
                                    <MenuButton
                        ...
                        <div
                            ...
                            className={clsx(
                                "text-gray-600 cursor-pointer flex items-center transition-colors",
                                {
                                    "!text-[#5F4BD9] font-semibold":
                        ...
                        >
                            Transactions
                            {
                                total > 0 && <span
                                    ...
                                    className="text-[#5F4BD9] ml-[6px] text-[12px] font-medium rounded-[6px] px-[8px] py-[4px] leading-[16px]"
                                >
                                    {total} Pending
                                </span>
                            }
                        ...
                        <Menu>
                            {({ close }) => (
                                <>
                                    ...
                                    <MenuItems
                                        anchor="bottom"
                                        className="p-[10px] z-[1] cursor-pointer outline-none border-none text-[12px] font-medium rounded-[10px] bg-white shadow-[0px_1px_4px_0px_#1A1D251F]"
                                    >
                                        <MenuItem>
                                            <div
                                                onClick={async () => {
                                                ...
                                                className="bg-[#F2F3F8] md:hidden rounded-[8px] w-[150px] mb-[10px] h-[36px] flex items-center pl-[10px]"
                                            >
                                                Bridge
                                            </div>
                                        </MenuItem>
